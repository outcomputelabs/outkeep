...
namespace Outkeep.Core.Caching
{
    ...
    public static class CacheEntryExtensions
    {
        ...
        public static ICacheEntry<TKey> SetUtcLastAccessed<TKey>(this ICacheEntry<TKey> entry, DateTimeOffset utcLastAccessed)
        {
        ...
        /// <returns>The same cache entry instance to allow chaining.</returns>
        public static ICacheEntry<TKey> SetAbsoluteExpiration<TKey>(this ICacheEntry<TKey> entry, DateTimeOffset? absoluteExpiration)
        {
        ...
        /// <returns>The same cache entry instance to allow chaining.</returns>
        public static ICacheEntry<TKey> SetSlidingExpiration<TKey>(this ICacheEntry<TKey> entry, TimeSpan? slidingExpiration)
        {
            if (entry == null) throw new ArgumentNullException(nameof(entry));
        ...
        /// <returns>The same cache entry instance to allow chaining.</returns>
        public static ICacheEntry<TKey> SetPriority<TKey>(this ICacheEntry<TKey> entry, CachePriority priority)
        {
            if (entry == null) throw new ArgumentNullException(nameof(entry));
        ...
        /// </summary>
        public static ICacheEntry<TKey> ContinueWithOnEvicted<TKey>(this ICacheEntry<TKey> entry, Action<Task<CacheEvictionArgs<TKey>>, object?> action, object? state, CancellationToken cancellationToken = default)
        {
            if (entry == null) throw new ArgumentNullException(nameof(entry));
        ...
        /// Convenience method to schedule a continuation on the <see cref="ICacheEntry.Evicted"/> property using the current task scheduler.
        /// </summary>
        public static ICacheEntry<TKey> ContinueWithOnEvicted<TKey>(this ICacheEntry<TKey> entry, Action<Task<CacheEvictionArgs<TKey>>> action, CancellationToken cancellationToken = default)
        {
        ...
        /// Convenience method to schedule a continuation on the <see cref="ICacheEntry.Evicted"/> property using the current task scheduler.
        /// </summary>
        public static ICacheEntry<TKey> ContinueWithOnEvicted<TKey>(this ICacheEntry<TKey> entry, Action<Task<CacheEvictionArgs<TKey>>> action, out Task continuation, CancellationToken cancellationToken = default)
        {
            if (entry == null) throw new ArgumentNullException(nameof(entry));
